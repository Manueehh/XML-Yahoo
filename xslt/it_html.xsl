  ...
  <xsl:template match="/">
    <html lang="it">
      ...
      <body>
        ...
        <div class="resumen">
          <strong>Totale domande:</strong> <xsl:value-of select="count(//document)"/>
        </div>
    ...
    <div class="documento">
      ...
      <xsl:if test="count(nbestanswers/answer_item) > 1">
        <div class="otras">
          <details>
            <summary>
              Altre risposte (<xsl:value-of select="count(nbestanswers/answer_item) - 1"/>)
            </summary>
      ...
      <div class="meta">
        ...
        Autore: <xsl:value-of select="id"/> |
        Migliore risposta di: <xsl:value-of select="best_id"/> |
        Lingua: <xsl:value-of select="language"/>
      </div>
    </div>
  </xsl:template>
